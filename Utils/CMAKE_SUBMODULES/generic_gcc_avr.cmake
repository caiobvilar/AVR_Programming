...
if(NOT AVR_UPLOADTOOL_PORT)
    set(
            AVR_UPLOADTOOL_PORT /dev/ttyACM0
            CACHE STRING "Set default upload tool port: /dev/ttyACM0"
    )
...
if(NOT AVR_MCU)
    set(
            AVR_MCU atmega2560
            CACHE STRING "Set default MCU: atmega2560 (see 'avr-gcc --target-help' for valid values)"
    )
endif(NOT AVR_MCU)
